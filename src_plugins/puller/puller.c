...
static pcb_r_dir_t arc_callback(const rnd_box_t * b, void *cl)
{
	/* pcb_layer_t *layer = (pcb_layer_t *) cl; */
...
static pcb_r_dir_t find_pair_line_callback(const rnd_box_t * b, void *cl)
{
...
static pcb_r_dir_t find_pair_arc_callback(const rnd_box_t * b, void *cl)
{
...
static pcb_r_dir_t find_pair_pstkline_callback(const rnd_box_t *b, void *cl)
{
	pcb_line_t *line = (pcb_line_t *)b;
	...
	if (pcb_isc_pstk_line(pcb_find0, pin, line)) {
#if TRACE1
...
static pcb_r_dir_t find_pair_pstkarc_callback(const rnd_box_t *b, void *cl)
{
	pcb_arc_t *arc = (pcb_arc_t *)b;
	pcb_pstk_t *pin = (pcb_pstk_t *)cl;
	Extra *e = ARC2EXTRA(arc);
...
static pcb_r_dir_t gp_line_cb(const rnd_box_t * b, void *cb)
{
...
static pcb_r_dir_t gp_arc_cb(const rnd_box_t * b, void *cb)
{
...
static pcb_r_dir_t gp_text_cb(const rnd_box_t * b, void *cb)
{
...
static pcb_r_dir_t gp_poly_cb(const rnd_box_t * b, void *cb)
{
	int i;
...
static pcb_r_dir_t gp_pstk_cb(const rnd_box_t *b, void *cb)
{
