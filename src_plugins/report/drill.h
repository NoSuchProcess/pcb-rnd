...
void drill_info_free(DrillInfoType *);
void drill_round_info(DrillInfoType *, int);
DrillType *drill_info_alloc(DrillInfoType *);
pcb_any_obj_t **drill_pin_alloc(DrillType *);
pcb_any_obj_t **drill_element_alloc(DrillType *);
