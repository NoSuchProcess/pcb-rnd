...
typedef enum {
	...
	PCB_PSTK_COMPAT_RRECT_H,
	PCB_PSTK_COMPAT_RRECT_V,
...
#define PCB_PSTK_VIA_COMPAT_FLAGS (PCB_FLAG_CLEARLINE | PCB_FLAG_SELECTED | PCB_FLAG_WARN | PCB_FLAG_USETHERMAL | PCB_FLAG_LOCK)
