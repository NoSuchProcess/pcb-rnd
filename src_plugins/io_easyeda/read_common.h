...
extern pcb_layer_type_t std_layer_id2type[];
extern int std_layer_id2type_size;

#define LAYERTAB_INNER -1
extern const int layertab[];
extern const int layertab_in_first;
extern const int layertab_in_last;
