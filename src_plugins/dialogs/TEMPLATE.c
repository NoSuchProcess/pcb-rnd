...
static void pcb_dlg_foo(whatever args) <<<- edit this
{
	...
	PCB_DAD_NEW(foo_ctx.dlg, "EDIT THIS", "EDIT THIS", &foo_ctx, pcb_false, foo_close_cb);
}

static const char pcb_acts_Foo[] = "Foo(object)\n"; <<<- edit this
static const char pcb_acth_Foo[] = ""; <<<- edit this
static int pcb_act_Foo(int argc, const char **argv, pcb_coord_t x, pcb_coord_t y) <<<- edit this
{
	return 0;
}
