...
static void view_save_btn_cb(void *hid_ctx, void *caller_data, pcb_hid_attribute_t *attr_btn)
{
	...
	fn = pcb_gui->fileselect("Save view list", "Save all views from the list", "view.lht", "lht", "view", 0, NULL);
	if (fn == NULL)
		return;
...
static void view_load_btn_cb(void *hid_ctx, void *caller_data, pcb_hid_attribute_t *attr_btn)
{
	...
	fn = pcb_gui->fileselect("Load view list", "Load all views from the list", "view.lht", "lht", "view", PCB_HID_FSD_READ, NULL);
	if (fn == NULL)
		return;
