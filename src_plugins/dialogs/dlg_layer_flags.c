...
static fgw_error_t pcb_act_LayerPropGui(fgw_arg_t *res, int argc, fgw_arg_t *argv)
{
	...
	PCB_DAD_AUTORUN("layer_prop", dlg, "Edit the properties of a logical layer", NULL, ok);
