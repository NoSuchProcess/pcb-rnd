...
void fontsel_expose_cb(rnd_hid_attribute_t *attrib, rnd_hid_preview_t *prv, rnd_hid_gc_t gc, rnd_hid_expose_ctx_t *e)
{
...
{
	rnd_event_bind(RND_EVENT_DESIGN_SET_CURRENT, fontsel_bchanged_ev, NULL, fontsel_cookie);
	rnd_event_bind(RND_EVENT_DESIGN_META_CHANGED, fontsel_mchanged_ev, NULL, fontsel_cookie);
