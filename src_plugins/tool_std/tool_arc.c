...
void pcb_tool_arc_notify_mode(pcb_hidlib_t *hl)
{
	...
	case PCB_CH_STATE_FIRST:
		pcb_crosshair.AttachedBox.Point1.X = pcb_crosshair.AttachedBox.Point2.X = pcb_crosshair_note.X;
		pcb_crosshair.AttachedBox.Point1.Y = pcb_crosshair.AttachedBox.Point2.Y = pcb_crosshair_note.Y;
		pcb_crosshair.AttachedBox.State = PCB_CH_STATE_SECOND;
		break;
	...
	case PCB_CH_STATE_THIRD:
		{
			...
			wx = pcb_crosshair_note.X - pcb_crosshair.AttachedBox.Point1.X;
			wy = pcb_crosshair_note.Y - pcb_crosshair.AttachedBox.Point1.Y;
