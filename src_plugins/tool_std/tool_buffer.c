...
static void pcb_tool_buffer_notify_mode_(rnd_design_t *hl, rnd_bool keep_ids, rnd_bool enable_fp_replace)
{
	...
	if (pcb_buffer_copy_to_layout(pcb, pcb_crosshair.AttachedObject.tx, pcb_crosshair.AttachedObject.ty, keep_ids, rnd_true)) {
...
void pcb_tool_buffer_adjust_attached_objects(rnd_design_t *hl)
{
