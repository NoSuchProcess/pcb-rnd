...
static const char pcb_acts_Savetedax[] = "SaveTedax(board-footprints|stackup, filename)";
...
static const char pcb_acts_LoadtedaxFrom[] = "LoadTedaxFrom(netlist|footprint|stackup, filename)";
