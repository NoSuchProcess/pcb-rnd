...
int pplg_init_lib_hid_pcbui(void)
{
	...
	rnd_event_bind(RND_EVENT_DESIGN_REPLACED, pcb_layer_menu_update_ev, NULL, layer_cookie);
	...
	rnd_event_bind(RND_EVENT_DESIGN_REPLACED, pcb_rst_update_ev, NULL, rst_cookie);
	...
	rnd_event_bind(RND_EVENT_DESIGN_REPLACED, pcb_infobar_brdchg_ev, NULL, infobar_cookie);
	rnd_event_bind(RND_EVENT_DESIGN_FN_CHANGED, pcb_infobar_fn_chg_ev, NULL, infobar_cookie);
	...
	rnd_event_bind(RND_EVENT_DESIGN_REPLACED, pcb_title_board_changed_ev, NULL, title_cookie);
	rnd_event_bind(RND_EVENT_DESIGN_FN_CHANGED, pcb_title_board_changed_ev, NULL, title_cookie);
	rnd_event_bind(RND_EVENT_DESIGN_META_CHANGED, pcb_title_meta_changed_ev, NULL, title_cookie);
