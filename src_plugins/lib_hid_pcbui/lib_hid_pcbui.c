...
int pplg_init_lib_hid_pcbui(void)
{
	...
	rnd_event_bind(RND_EVENT_BOARD_REPLACED, pcb_layer_menu_update_ev, NULL, layer_cookie);
	...
	rnd_event_bind(RND_EVENT_BOARD_REPLACED, pcb_rst_update_ev, NULL, rst_cookie);
	...
	rnd_event_bind(RND_EVENT_BOARD_REPLACED, pcb_infobar_brdchg_ev, NULL, infobar_cookie);
	...
	rnd_event_bind(RND_EVENT_BOARD_REPLACED, pcb_title_board_changed_ev, NULL, title_cookie);
