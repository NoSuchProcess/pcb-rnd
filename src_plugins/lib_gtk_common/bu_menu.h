...
void ghid_main_menu_update_toggle_state(pcb_hidlib_t *hidlib, GHidMainMenu *menu, void (*cb)(pcb_hidlib_t *hidlib, GtkAction *, const char *toggle_flag, const char *active_flag));
