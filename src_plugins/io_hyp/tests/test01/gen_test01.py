...
print "{STACKUP"
print "  (SIGNAL T=0.001778 L=1 C=1.67e-008)"
print "  (DIELECTRIC T=0.149900 C=4.700000)"
print "  (PLANE  T=0.001778 L=2 C=1.67e-008)"
print "}"
print "{DEVICES"
print "  (? REF=U1 NAME=BC848 NPN 1x1 L=1)"
print "}"
...
for x in range (0, max):
  ...
  y2 = y0 + r * sin (alpha)
  w = (x + 1) * 0.1 / max
  print "  (SEG X1=%f Y1=%f X2=%f Y2=%f W=%f L=1)" % ( x1, y1, x2, y2, w)
...
for a in range (0, max):
  for b in range (0, max):
    ...
    x2 = xc + r * cos (beta)
    y2 = yc + r * sin (beta)
    print "  (ARC X1=%f Y1=%f X2=%f Y2=%f XC=%f YC=%f R=%f W=%f L=1)" % ( x1, y1, x2, y2, xc, yc, r, w)
...
print "  (SEG X1=13 Y1=1 X2=13 Y2=2 W=0.1 L=1)"
print "  (SEG X1=13 Y1=2 X2=13 Y2=3 W=0.1 L=1)"
print "  (SEG X1=13 Y1=3 X2=13 Y2=4 W=0.1 L=1)"
print "}"
...
print "{NET=oldviatst"
print "  (VIA X=14 Y=1 D=0.2 L1=1 S1=ROUND S1X=0.5 S1Y=0.5)"
print "  (VIA X=14 Y=2 D=0.2 L1=1 L2=2 S1=RECT S1X=0.5 S1Y=0.5)"
print "  (VIA X=14 Y=3 D=0.2 L1=1 L2=2 S1=OBLONG S1X=0.5 S1Y=0.5)"
print "  (VIA X=14 Y=4 D=0.0 L1=1 L2=2 S1=ROUND S1X=0.5 S1Y=0.5)"
print "  (SEG X1=14 Y1=1 X2=14 Y2=2 W=0.1 L=1)"
print "  (SEG X1=14 Y1=2 X2=14 Y2=3 W=0.1 L=1)"
print "  (SEG X1=14 Y1=3 X2=14 Y2=4 W=0.1 L=1)"
print "}"
...
print "{NET=(padtst)"
print "  (PAD X=16 Y=1 L=1 S=ROUND SX=0.5 SY=0.5)"
print "  (PAD X=16 Y=2 L=1 S=RECT SX=0.5 SY=0.5)"
print "  (PAD X=16 Y=3 L=1 S=OBLONG SX=0.5 SY=0.5)"
print "  (PAD X=17 Y=1 L=2 S=ROUND SX=0.5 SY=0.5)"
print "  (PAD X=17 Y=2 L=2 S=RECT SX=0.5 SY=0.5)"
print "  (PAD X=17 Y=3 L=2 S=OBLONG SX=0.5 SY=0.5)"
print "}"

print "{NET=(usegtst)"
print "  (USEG X1=18 Y1=1 L1=1 X2=19 Y2=1 L2=1 ZL=1 ZW=0.1 ZLEN=2 )"
print "  (USEG X1=18 Y1=2 L1=1 X2=19 Y2=2 L2=1 Z=50 D=1e-12 R=5 )"
print "  (USEG X1=18 Y1=3 L1=1 X2=19 Y2=3 L2=2 ZL=1 ZW=0.1 ZLEN=2 )"
print "  (USEG X1=18 Y1=4 L1=1 X2=19 Y2=4 L2=2 Z=50 D=1e-12 R=5 )"
print "}"
...
print "  {POLYGON L=1 W=0.05 ID=1 X=%f Y=%f)" % (x0-w, y0-w)
print "     (LINE X=%f Y=%f)" % (x0+w, y0-w)
print "     (LINE X=%f Y=%f)" % (x0+w, y0+w)
print "     (LINE X=%f Y=%f)" % (x0-w, y0+w)
print "     (LINE X=%f Y=%f)" % (x0-w, y0-w)
print "  }"
print "  {POLYLINE L=1 W=0.1 ID=1 X=%f Y=%f" % (x0, y0)
...
print "{NET=curvetst"
print "  {POLYGON L=1 W=0.05 ID=2 X=%f Y=%f)" % (x0+r, y0)
...
print "{NET=linetst"
print "  {POLYGON L=1 W=0.05 ID=3 X=%f Y=%f)" % (x0, y0)
...
def mkpolygon (typ, linewdth, id, x0, y0, w, h):
  print "  {POLYGON L=1 T=%s W=%f ID=%i X=%f Y=%f)" % (typ, linewdth, id, x0, y0)
...
print "  (SEG X1=%f Y1=%f X2=%f Y2=%f W=0.04 L=1)" % (x1, y0+h/2.0, x2, y0+h/2.0)
print "  (SEG X1=%f Y1=%f X2=%f Y2=%f W=0.04 L=1)" % (x1, y0+h/2.0+s, x2, y0+h/2.0+s)
print "  (SEG X1=%f Y1=%f X2=%f Y2=%f W=0.04 L=1)" % (x1, y0+h/2.0+2*s, x2, y0+h/2.0+2*s)
print "  (SEG X1=%f Y1=%f X2=%f Y2=%f W=0.04 L=1)" % (x1, y0+h/2.0, x1, y0+h/2.0+s)
print "  (SEG X1=%f Y1=%f X2=%f Y2=%f W=0.04 L=1)" % (x1, y0+h/2.0+s, x1, y0+h/2.0+2*s)
