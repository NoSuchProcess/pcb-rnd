...
print "  (VIA X=14 Y=3 D=0.2 L1=component L2=solder S1=OBLONG S1X=0.5 S1Y=0.5)"
...
print "  (PAD X=16 Y=3 L=component S=OBLONG SX=0.5 SY=0.5)"
print "  (PAD X=17 Y=1 L=solder S=ROUND SX=0.5 SY=0.5)"
print "  (PAD X=17 Y=2 L=solder S=RECT SX=0.5 SY=0.5)"
print "  (PAD X=17 Y=3 L=solder S=OBLONG SX=0.5 SY=0.5)"
print "}"
