...
module mpak()
{
	module mpak_()
	{
		...
		rotate([90,0,-90]) scale([1.0,1.0,1.0])translate([-5.6, 0.4, -  6.35 + 1.25]) {
			// body
			color([0.1,0.1,0.1])
			...
			// 3 pins
			color([0.9, 0.9, 0.9]) {
				translate([3.6,1.96,1.27-0.45/2])
					pin(2.6, 1.2, 0.45);
				translate([3.6,1.96,2.54-0.45/2])
					pin(2.6, 1.2, 0.45);
				translate([3.6,1.96,3.81-0.45/2])
					pin(2.6, 1.2, 0.45);
				translate([3.6,1.96,5.08-0.45/2])
					pin(2.6, 1.2, 0.45);

				translate([-3.6,1.96,3.17-3.18/2])
					pin(-2.6, 1.2, 3.18);
			}
		}
	}
