...
module package_sod87(fillet=0) {
   ...
   module fillet() {
	...
	translate([-1.575,0,1.025]) {
        if(fillet) {
            color([0.8,0.8,0.8]) {
                translate([+body_len+pad_len, 0, 0])
                    fillet();
                translate([0, 0, 0])
                    rotate([0,0,180])
                        fillet();
		...
		rotate([0,90,0]) {
			union () {
				color([1,0.1,0.1]) {
					translate([0,0,0.3/2])
						rounded_cylinder(r=0.95,h=2.9,n=0.2);
				}
				color([0.1,0.1,0.1]) {
					translate([0,0,0.7])
						cylinder(r=0.96, h=0.35);
				}
				color([0.8,0.8,0.8]) {
					translate([0,0,-0.3/2])
						cylinder(r=1.025, h=0.3);

					translate([0,0,0.3/2 + 2.9])
						cylinder(r=1.025, h=0.3);
				}
			}
		}
