// Model for horizontal TO220 package and S offset middle pin variant
//
...
module part_to220(pins=3, S=0, pin_descent=2.5)
{
    pin_thickness = 0.5;
    pin_width1 = 1.45;
    pin_width2 = 0.85;
    ...
    translate([-1.02,0,body_offset+pin_thickness/2]) {
        rotate([0,0,90]) {
            union() {
                color([0.9, 0.9, 0.9]) {
                    if (pins==3) {
