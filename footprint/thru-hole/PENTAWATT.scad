        ...
        rotate([0,-90,180])
            translate([-pin_thickness/2,0,-pin_width/2])
                scale([1.606,1.0]) // 2.2 -> need to scale: 1.606
                    linear_extrude(height=pin_width)
                        polygon([[0,0],[0.2,0],[0.2,0.71],[0.21,0.8],[0.24,0.89],[0.31,1.02],[1.40,2.31],[1.54,2.5],[1.62,2.66],[1.65,2.80],[1.66,2.98],[1.67,3.18],[1.67,5.5],[1.37,5.5],[1.37,3.4],[1.36,3.2],[1.34,3.01],[1.29,2.85],[1.22,2.68],[1.12,2.52],[1.02,2.38],[0.2,1.4],[0.13,1.26],[0.06,1.10],[0.01,0.96],[0,0.8]]);
        }
