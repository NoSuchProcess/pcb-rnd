...
plugin_def("lib_hid_pcbui",    "all-gui-hid common PCB GUI elements",sdisable, 0)
...
plugin_dep("hid_lesstif", "lib_hid_pcbui", 0)
...
plugin_dep("lib_gtk_common", "lib_hid_pcbui", 0)
plugin_dep("lib_gtk_hid", "lib_hid_common", 0)
plugin_dep("lib_gtk_hid", "lib_hid_pcbui", 0)
