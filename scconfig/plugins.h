...
plugin_def("draw_pnp",         "auto-generated pnp layer",        sbuildin, 1)
plugin_def("drc_query",        "query() based DRC",               sbuildin, 1)
plugin_def("emsim",            "bridge to emsim-rnd",             sdisable, 0)
...
plugin_def("rbs_routing",      "Rubber Band Stretch Routing",     sdisable, 0)
...
plugin_def("trimesh",          "triangulated mesh",               sbuildin, 1)
...
plugin_def("export_emsim",     "export to emsim-rnd",             sdisable, 0)
...
plugin_def("export_hpgl",      "export thin-drawing in hpgl",     sbuildin, 1)
...
plugin_def("io_easyeda",       "EasyEDA board & footprint",       sbuildin, 1)
...
plugin_dep("emsim", "export_emsim")
plugin_dep("export_emsim", "io_tedax")
plugin_dep("export_emsim", "lib_polyhelp")
plugin_dep("export_fidocadj", "lib_compat_help")
plugin_dep("export_gcode", "millpath")
plugin_dep("export_gerber", "export_excellon")
plugin_dep("export_hpgl", "millpath")
...
plugin_dep("io_easyeda", "lib_compat_help")
plugin_dep("io_easyeda", "shape")
...
plugin_dep("rbs_routing", "lib_netmap")
plugin_dep("report", "query")
plugin_dep("show_netnames", "query")
plugin_dep("trimesh", "lib_polyhelp")
