...
plugin_def("lib_gtk_hid",      "hid_gtk generic part",            sdisable, 0, 0)
plugin_def("lib_hid_common",   "all-gui-hid common code",         sdisable, 0, 0)
...
plugin_def("export_stl",       "3d export: STL ",                 sdisable, 1, 0)
