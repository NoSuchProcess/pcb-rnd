...
plugin_def("lib_formula",      "mathematical formulas",           sbuildin, 1, 0)
plugin_def("lib_gensexpr",     "#s-expression library",           sdisable, 0, 1)
plugin_def("lib_gtk_common",   "all-hid_gtk common code",         sdisable, 0, 1)
plugin_def("lib_hid_common",   "all-gui-hid common code",         sdisable, 0, 1)
plugin_def("lib_hid_gl",       "openGL rendering",                sdisable, 0, 1)
...
plugin_def("lib_portynet",     "#IPv4 tcp",                       sbuildin, 1, 1)
plugin_def("lib_vfs",          "fetch data for VFS export",       sdisable, 0, 0)
plugin_def("lib_wget",         "wget(1) wrapper",                 sdisable, 0, 1)
...
plugin_def("ar_extern",        "external autorouter",             sbuildin, 1, 0)
...
plugin_def("irc",              "on-line support (IRC)",           sbuildin, 1, 1)
plugin_def("jostle",           "push lines out of the way",       sbuildin, 1, 0)
plugin_def("loghid",           "diagnostics: log HID calls",      sdisable, 1, 1)
...
plugin_def("show_netnames",    "display network names over tracks",sbuildin, 1, 0)
plugin_def("sketch_route",     "assisted semi-auto-routing",      sdisable, 0, 0)
...
plugin_header("\nImport plugins:\n")
plugin_def("import_accel_net", "import Accel netlist",            sbuildin, 1, 0)
...
plugin_def("export_c_draw",    "export drawing in C code",        sdisable, 0, 0)
...
plugin_def("io_bxl",           "BXL footprint",                   sbuildin, 1, 0)
...
plugin_def("io_pads",          "PADS board",                      sbuildin, 1, 0)
...
plugin_dep("import_accel_net", "lib_gensexpr", 0)
...
plugin_dep("import_orcad_net", "lib_gensexpr", 0)
