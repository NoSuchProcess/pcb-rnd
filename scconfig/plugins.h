...
plugin_def("boardflip",        "flip board objects",              sbuildin, 1)
...
plugin_def("script",           "fungw turing complete scripting", sdisable, 1)
...
plugin_def("export_nelma",     "nelma pcb_exporter",              sdisable, 1)
...
plugin_dep("gpmi", "lib_compat_help")
plugin_dep("hid_gtk2_gdk", "draw_csect")
plugin_dep("hid_gtk2_gdk", "draw_fontsel")
...
plugin_dep("hid_gtk3_gl", "draw_fontsel")
...
plugin_dep("io_autotrax", "boardflip")
