...
plugin_dep("hid_gtk2_gdk", "draw_csect", 01)
plugin_dep("hid_gtk2_gdk", "lib_gtk_common", 01)
plugin_dep("hid_gtk2_gdk", "lib_gtk_hid", 01)
plugin_dep("hid_gtk2_gl", "draw_csect", 0)
plugin_dep("hid_gtk2_gl", "lib_gtk_common", 0)
plugin_dep("hid_gtk2_gl", "lib_gtk_hid", 0)
plugin_dep("hid_gtk2_gl", "lib_hid_gl", 0)
plugin_dep("hid_gtk3_cairo", "draw_csect", 0)
plugin_dep("hid_gtk3_cairo", "lib_gtk_common", 0)
plugin_dep("hid_gtk3_cairo", "lib_gtk_hid", 0)
plugin_dep("hid_lesstif", "dialogs", 0)
plugin_dep("hid_lesstif", "draw_csect", 0)
...
plugin_dep("lib_gtk_common", "dialogs", 0)
plugin_dep("lib_gtk_hid", "dialogs", 0)
plugin_dep("lib_gtk_hid", "lib_hid_common", 0)
