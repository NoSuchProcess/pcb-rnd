...
action_entry(FootprintToBuffer)
action_entry(ForceThaw)
action_entry(Freeze)
action_entry(GetSource)
action_entry(Grid)
action_entry(Hash)
action_entry(Invert)
action_entry(Layer)
...
action_entry(Need)
action_entry(Next)
action_entry(NoAutoLen)
action_entry(Normalize)
action_entry(Notify)
action_entry(NoAllRats)
action_entry(NoRats)
action_entry(Object)
action_entry(Off)
action_entry(On)
...
action_entry(Tool)
action_entry(Transparent)
action_entry(Unselect)
action_entry(UnFreeze)
action_entry(Via)
action_entry(Warp)
action_entry(WireFrame)
action_entry(Zoom)
