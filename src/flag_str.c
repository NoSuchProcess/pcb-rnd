...
pcb_flag_bits_t pcb_object_flagbits[] = {
	...
	{FN(PCB_FLAG_AUTO),          N("auto"),          PCB_OBJ_LINE|PCB_OBJ_ARC|PCB_OBJ_PSTK, "For lines and vias, indicates that these were created by the autorouter.", 0, 0},
	...
	{FN(PCB_FLAG_DRC),           N("drc"),           PCB_OBJ_ANY, "Set for objects that fail DRC: flag like FOUND flag for DRC checking.", 0, 1}, /* omit from list so that partial export is included */
