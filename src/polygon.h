...
pcb_polyarea_t *ArcPoly(pcb_arc_t * l, Coord thick);
pcb_polyarea_t *PinPoly(pcb_pin_t * l, Coord thick, Coord clear);
pcb_polyarea_t *BoxPolyBloated(pcb_box_t * box, Coord radius);
void frac_circle(pcb_pline_t *, Coord, Coord, pcb_vector_t, int);
