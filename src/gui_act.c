...
static fgw_error_t pcb_act_Display(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_Mode(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_CycleDrag(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	void *ptr1, *ptr2, *ptr3;
	int over = 0;
...
static fgw_error_t pcb_act_Message(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	int i;
...
static fgw_error_t pcb_act_ToggleHideName(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_MarkCrosshair(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
...
static fgw_error_t pcb_act_RouteStyle(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_CreateMenu(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	if (pcb_gui == NULL) {
...
static fgw_error_t pcb_act_RemoveMenu(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	if (pcb_gui == NULL) {
...
static fgw_error_t pcb_act_SetSame(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_coord_t x, y;
	void *ptr1, *ptr2, *ptr3;
...
static fgw_error_t pcb_act_SwitchHID(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_FullScreen(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_PCBChanged(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_NetlistChanged(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_RouteStylesChanged(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_event(PCB_EVENT_ROUTE_STYLES_CHANGED, NULL);
	return 0;
...
static fgw_error_t pcb_act_LibraryChanged(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_Cursor(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_EditLayer(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_EditGroup(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	int ret = 0, n, interactive = 1, explicit = 0;
...
static fgw_error_t pcb_act_SelectLayer(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_layer_id_t lid;
...
static fgw_error_t pcb_act_ChkLayer(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_layer_id_t lid;
	pcb_layer_t *ly;
...
static fgw_error_t pcb_act_ToggleView(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_layer_id_t lid;
...
static fgw_error_t pcb_act_ChkView(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_layer_id_t lid;
	pcb_layer_t *ly;
...
static fgw_error_t pcb_act_SetUnits(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_grid(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	if (argc == 0)
		return 0;
...
static fgw_error_t pcb_act_ChkRst(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	int rid;
...
%end-doc */
static fgw_error_t pcb_act_GetXY(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_coord_t x, y;
...
fgw_error_t pcb_act_PrintCalibrate(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
