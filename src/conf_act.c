...
static fgw_error_t pcb_act_Conf(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_GetStyle(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_ChkMode(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_ChkGridSize(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	assert(argc == 1);
...
static fgw_error_t pcb_act_ChkSubcID(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_ChkGridUnits(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	assert(argc == 1);
...
static fgw_error_t pcb_act_ChkBuffer(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
