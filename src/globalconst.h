...
#define MAX_LAYER        16    /* max number of layer, check source code for more changes, a *lot* more changes */
...
#define MAX_BUFFER       5 /* number of pastebuffers additional changes in menu.c are also required to select more buffers */

#define DEFAULT_DRILLINGHOLE 40 /* default inner/outer ratio for pins/vias in percent */
