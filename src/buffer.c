...
fgw_error_t pcb_act_LoadFootprint(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
fgw_error_t pcb_act_FreeRotateBuffer(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *angle_s;
...
%end-doc */
static fgw_error_t pcb_act_PasteBuffer(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
