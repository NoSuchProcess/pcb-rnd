...
#line 111 "res_parse.tab.c"			/* yacc.c:339  */
...
union YYSTYPE {
#line 43 "res_parse.y"					/* yacc.c:355  */

	int ival;
	char *sval;
	Resource *rval;

#line 162 "res_parse.tab.c"			/* yacc.c:355  */
};
...
#line 177 "res_parse.tab.c"			/* yacc.c:358  */
...
static const char *const yytname[] = {
	"$end", "error", "$undefined", "STRING", "INCLUDE", "'{'", "'}'", "'='",
	"$accept", "top_res", "$@1", "res", "$@2", "res_item_zm", "res_item", YY_NULLPTR
};
#endif
...
yyreduce:
	...
	switch (yyn) {
	case 2:
#line 55 "res_parse.y"					/* yacc.c:1646  */
		{
			current_res = parsed_res = resource_create(NULL);
		}
#line 1252 "res_parse.tab.c"		/* yacc.c:1646  */
		break;

	case 4:
#line 60 "res_parse.y"					/* yacc.c:1646  */
		{
			current_res = resource_create(current_res);
		}
#line 1258 "res_parse.tab.c"		/* yacc.c:1646  */
		break;

	case 5:
#line 62 "res_parse.y"					/* yacc.c:1646  */
		{
			(yyval.rval) = current_res;
			current_res = current_res->parent;
		}
#line 1264 "res_parse.tab.c"		/* yacc.c:1646  */
		break;

	case 8:
#line 67 "res_parse.y"					/* yacc.c:1646  */
		{
			resource_add_val(current_res, 0, (yyvsp[0].sval), 0);
			f(FLAG_V);
		}
#line 1270 "res_parse.tab.c"		/* yacc.c:1646  */
		break;

	case 9:
#line 68 "res_parse.y"					/* yacc.c:1646  */
		{
			resource_add_val(current_res, (yyvsp[-2].sval), (yyvsp[0].sval), 0);
			f(FLAG_NV);
		}
#line 1276 "res_parse.tab.c"		/* yacc.c:1646  */
		break;
...
#line 1282 "res_parse.tab.c"		/* yacc.c:1646  */
		break;

	case 11:
#line 70 "res_parse.y"					/* yacc.c:1646  */
		{
			resource_add_val(current_res, 0, 0, (yyvsp[0].rval));
			f(FLAG_S);
		}
#line 1288 "res_parse.tab.c"		/* yacc.c:1646  */
		break;

	case 12:
#line 71 "res_parse.y"					/* yacc.c:1646  */
		{
			resource_add_val(current_res, (yyvsp[-2].sval), 0, (yyvsp[0].rval));
			f(FLAG_NS);
		}
...
#line 1298 "res_parse.tab.c"		/* yacc.c:1646  */
	default:
		break;
	}
...
#line 75 "res_parse.y"					/* yacc.c:1906  */
...
Resource *resource_parse(const char *filename, const char **strings)
{
	res_lineno = 1;
	if (filename) {
...
char *resource_value(const Resource * res, char *name)
{
	...
	if (res == 0 || name == 0)
		return 0;
	for (i = 0; i < res->c; i++)
		if (res->v[i].name && res->v[i].value && NSTRCMP(res->v[i].name, name) == 0)
...
Resource *resource_subres(const Resource * res, const char *name)
{
	...
	if (res == 0 || name == 0)
		return 0;
	for (i = 0; i < res->c; i++)
		if (res->v[i].name && res->v[i].subres && NSTRCMP(res->v[i].name, name) == 0)
...
{
	fprintf(stderr, "Error: %s around line %d: %s\n", res_file ? res_filename : "internal strings", res_lineno, str);
	return 0;
}
