...
int resparse (void *YYPARSE_PARAM);
#else
int resparse ();
#endif
#else /* ! YYPARSE_PARAM */
...
{
       9,     0,    -1,    -1,    10,    13,    -1,    -1,    12,     5,
      13,     6,    -1,    14,    13,    -1,    -1,     3,    -1,     3,
       7,     3,    -1,     4,    -1,    11,    -1,     3,     7,    11,
      -1,     1,    -1
};
...
static const char *const yytname[] =
{
  ...
  "$accept", "top_res", "$@1", "res", "$@2", "res_item_zm", "res_item", YY_NULL
};
#endif
