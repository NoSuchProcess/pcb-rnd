...
/* PCB calback events */
gpmi_define_event(HIDE_set_layer)(void *hid, const char *name, int group);
...
gpmi_define_event(HIDE_draw_arc)(void *hid, void *gc, int cx, int cy, int xradius, int yradius, int start_angle, int delta_angle);
