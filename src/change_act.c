...
static fgw_error_t pcb_act_ChangeSize(int oargc, const char **oargv);
static fgw_error_t pcb_act_Change2ndSize(int oargc, const char **oargv);
...
static fgw_error_t pcb_act_ChangeClearSize(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_ChangeFlag(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
...
static fgw_error_t pcb_act_ChangeHole(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
static fgw_error_t pcb_act_ChangePaste(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_message(PCB_MSG_ERROR, "Feature not supported with padstacks.\n");
	return 1;
...
static fgw_error_t pcb_act_ChangeSizes(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	int a, b, c;
...
static fgw_error_t pcb_act_ChangePinName(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
...
fgw_error_t pcb_act_ChangeName(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
	char *name;
...
static fgw_error_t pcb_act_ChangeJoin(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
	if (function) {
...
static fgw_error_t pcb_act_ChangeNonetlist(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
	if (function) {
...
static fgw_error_t pcb_act_ChangeSquare(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_message(PCB_MSG_ERROR, "Feature not supported with padstacks.\n");
	return 1;
...
static fgw_error_t pcb_act_SetSquare(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_message(PCB_MSG_ERROR, "Feature not supported with padstacks.\n");
	return 1;
...
static fgw_error_t pcb_act_ClearSquare(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_message(PCB_MSG_ERROR, "Feature not supported with padstacks.\n");
	return 1;
...
static fgw_error_t pcb_act_ChangeOctagon(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_message(PCB_MSG_ERROR, "Feature not supported with padstacks.\n");
	return 1;
...
static fgw_error_t pcb_act_SetOctagon(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_message(PCB_MSG_ERROR, "Feature not supported with padstacks.\n");
	return 1;
...
static fgw_error_t pcb_act_ClearOctagon(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	pcb_message(PCB_MSG_ERROR, "Feature not supported with padstacks.\n");
	return 0;
...
static fgw_error_t pcb_act_SetThermal(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
...
static fgw_error_t pcb_act_SetFlag(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
	const char *flag = PCB_ACTION_ARG(1);
...
static fgw_error_t pcb_act_ClrFlag(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
	const char *flag = PCB_ACTION_ARG(1);
...
static fgw_error_t pcb_act_SetValue(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
...
static fgw_error_t pcb_act_ChangeAngle(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
...
static fgw_error_t pcb_act_ChangeRadius(int oargc, const char **oargv)
{
	PCB_OLD_ACT_BEGIN;
	const char *function = PCB_ACTION_ARG(0);
	const char *prim  = PCB_ACTION_ARG(1);
