...
#define	PCB_CHANGENAME_TYPES        \
	(PCB_TYPE_PSTK | PCB_TYPE_TEXT | PCB_TYPE_SUBC | PCB_TYPE_LINE | \
	PCB_TYPE_ARC | PCB_TYPE_POLY | PCB_TYPE_SUBC_PART | PCB_TYPE_SUBC)

#define	PCB_CHANGESIZE_TYPES        \
	(PCB_TYPE_PSTK | PCB_TYPE_POLY | PCB_TYPE_LINE | PCB_TYPE_ARC | \
	PCB_TYPE_TEXT | PCB_TYPE_SUBC | PCB_TYPE_SUBC_PART)

#define	PCB_CHANGE2NDSIZE_TYPES     \
	(PCB_TYPE_PSTK | PCB_TYPE_SUBC | PCB_TYPE_SUBC_PART)

/* We include polygons here only to inform the user not to do it that way.  */
#define PCB_CHANGECLEARSIZE_TYPES \
	(PCB_TYPE_LINE | PCB_TYPE_ARC | PCB_TYPE_POLY | PCB_TYPE_SUBC | \
	PCB_TYPE_SUBC_PART)
