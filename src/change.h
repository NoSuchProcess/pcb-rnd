...
pcb_bool ChangeSelectedMaskSize(int, pcb_coord_t, pcb_bool);
...
pcb_bool ChangeObjectSize(int, void *, void *, void *, pcb_coord_t, pcb_bool);
pcb_bool ChangeObject1stSize(int, void *, void *, void *, pcb_coord_t, pcb_bool);
pcb_bool ChangeObjectThermal(int, void *, void *, void *, int);
pcb_bool ChangeObjectClearSize(int, void *, void *, void *, pcb_coord_t, pcb_bool);
pcb_bool ChangeObject2ndSize(int, void *, void *, void *, pcb_coord_t, pcb_bool, pcb_bool);
pcb_bool ChangeObjectMaskSize(int, void *, void *, void *, pcb_coord_t, pcb_bool);
...
void ChangePCBSize(pcb_coord_t, pcb_coord_t);
void *ChangeObjectPinnum(int Type, void *Ptr1, void *Ptr2, void *Ptr3, char *Name);
pcb_bool ChangeObjectRadius(int Type, void *Ptr1, void *Ptr2, void *Ptr3, int is_x, pcb_coord_t r, pcb_bool absolute);
