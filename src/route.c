...
void
pcb_route_destroy(pcb_route_t * p_route)
{
...
void
pcb_route_reset(pcb_route_t * p_route)
{
...
void
pcb_route_reserve(pcb_route_t * p_route,int size)
{
	int grow;
...
void
pcb_route_resize(pcb_route_t * p_route,int size)
{
...
pcb_route_object_t *
pcb_route_alloc_object(pcb_route_t * p_route)
{
...
void
pcb_route_add_line( pcb_route_t * p_route,pcb_point_t * point1,pcb_point_t * point2,pcb_layer_id_t layer )
{
...
void
pcb_route_add_arc( pcb_route_t * p_route,pcb_point_t * center,pcb_angle_t start_angle,pcb_angle_t delta,pcb_coord_t radius,pcb_layer_id_t layer )
{
	pcb_route_object_t * p_object = pcb_route_alloc_object(p_route);
	if(p_object == NULL)
		return;
...
void
pcb_route_calculate_corner_arc(	const pcb_point_t *		point1,
																const pcb_point_t *		point2,
																const pcb_point_t *		point3,
																double								radius,
																pcb_route_object_t *	p_out_obj,
																pcb_point_t *					p_endpoint1,
																pcb_point_t *					p_endpoint2
															)
{
...
void
pcb_route_calculate_45(pcb_point_t * start_point, pcb_point_t * target_point)
{
 ...
 *---------------------------------------------------------*/
void
pcb_route_draw_arc(	pcb_hid_gc_t	GC, 
					pcb_coord_t		x, 
					pcb_coord_t		y, 
 ...
 *---------------------------------------------------------*/
void
pcb_route_draw( pcb_route_t * p_route,pcb_hid_gc_t GC )
{
	int i=0;
	for(i=0;i<p_route->size;++i) {
