		...
		switch (p_obj->type) {
			case PCB_OBJ_LINE:
				...
				if (apply_to_line) {
					...
					rnd_rtree_delete(apply_to_line_layer->line_tree, apply_to_line, (rnd_rtree_box_t *)apply_to_line);
					...
					rnd_rtree_insert(layer->line_tree, apply_to_line, (rnd_rtree_box_t *)apply_to_line);
			...
			case PCB_OBJ_ARC:
				...
				if (apply_to_arc) {
					...
					if (changes > 0) {
						...
						rnd_rtree_delete(apply_to_arc_layer->arc_tree, apply_to_arc, (rnd_rtree_box_t *)apply_to_arc);
						...
						rnd_rtree_insert(apply_to_arc_layer->arc_tree, apply_to_arc, (rnd_rtree_box_t *)apply_to_arc);
